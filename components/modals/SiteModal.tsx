...
import { Building2, MapPin, IndianRupee, Smartphone, GitMerge, UploadCloud, Trash2 } from 'lucide-react';
...
export default function SiteModal({
  ...
  mockWhatsAppNumbers, mockStaff, mockTeams = []
}: SiteModalProps) {
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-3">
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input required type="text" placeholder="e.g. Mumbai" value={formData.city}
                onChange={(e) => setFormData({ ...formData, city: e.target.value })} className={inputCls} />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              <MapPin size={14} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 transition-colors" />
              <input required type="text" placeholder="e.g. Bandra West" value={formData.area}
                onChange={(e) => setFormData({ ...formData, area: e.target.value })} className={inputCls} />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              <Building2 size={14} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-500 transition-colors" />
              <input type="text" placeholder="e.g. 2BHK, 3BHK" value={formData.propertyTypes}
                onChange={(e) => setFormData({ ...formData, propertyTypes: e.target.value })} className={inputCls} />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input type="text" placeholder="e.g. 1.2Cr - 2.5Cr" value={formData.priceRange}
                onChange={(e) => setFormData({ ...formData, priceRange: e.target.value })} className={inputCls} />
            </div>
          </div>
